...
function SholatNiatSection() {
  ...
  return (
    <div className="min-h-screen bg-[url('/hijau2.png')] bg-repeat relative ">
      <div className="flex flex-col items-center py-10 overflow-hidden backdrop-blur-lg min-h-screen">
        {/* Bulan Sabit & Bintang */}
