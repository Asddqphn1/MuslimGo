...
function DaftarAsmaulhusna() {
  ...
  return (
    <div className="bg-fixed bg-[url('/biru.png')]">
      <div className="relative min-h-screen flex flex-col items-center p-5 text-white backdrop-blur-lg">
            ...
            {asmaulHusna.map((item) => (
              ...
              >
                ...
                <div className="absolute top-2 left-2">
                  <img src="/hijau.png" alt="Lentera" className="w-10 h-10" />
                </div>
                ...
                {/* Isi Kartu */}
                <p className="text-3xl amiri text-green-900 my-2">
                  {item.arab}
                </p>
